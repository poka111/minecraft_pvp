...
#看板のgiveコマンド
#/give @s minecraft:oak_sign{BlockEntityTag:{Text1:'[{"text":"","clickEvent":{"action":"run_command","value":"function poka:choose_kizin"}},{"text":"\\u9b3c\\u4eba","bold":true,"underlined":true,"color":"dark_red"},{"text":"\\u3092\\u9078\\u629e"}]'},display:{Name:'{"text":"Custom Sign"}'}}
#設置コマンド
...
execute as @s[scores={chose = 0}] run scoreboard players set @s[scores={chose = 0}] Kizin 1
...
tag @s add ready
execute as @s[scores={Kizin = 1}] run tp @s -4.5 -22 28.5
