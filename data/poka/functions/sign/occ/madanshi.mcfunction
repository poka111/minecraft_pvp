...
#看板のgiveコマンド
#/give @s minecraft:oak_sign{BlockEntityTag:{Text1:'[{"text":"","clickEvent":{"action":"run_command","value":"function poka:choose_madanshi"}},{"text":"\\u9b54\\u5f3e\\u58eb","bold":true,"underlined":true,"color":"dark_purple"},{"text":"\\u3092\\u9078\\u629e"}]'},display:{Name:'{"text":"Custom Sign"}'}}
#設置コマンド
#/setblock ~ ~1 ~ oak_wall_sign[facing = west]{Text1:'[{"text":"","clickEvent":{"action":"run_command","value":"function poka:choose_madanshi"}},{"text":"\\u9b54\\u5f3e\\u58eb","bold":true,"underlined":true,"color":"dark_purple"},{"text":"\\u3092\\u9078\\u629e"}]'}

execute as @s[scores={chose = 1}] run title @s[scores={chose = 1}] title "あなたは職業を選択済みです"
execute as @s[scores={chose = 0}] run scoreboard players set @s[scores={chose = 0}] Madansi 1
...
tag @s add ready
execute as @s[scores={Madansi = 1}] run tp @s -4.5 -22 28.5
title @a[scores={Madansi = 1}] actionbar {"text":"魔弾士を選択しました","color":"light_purple"}
