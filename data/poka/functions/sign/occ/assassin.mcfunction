...
#看板のgiveコマンド
#/give @s minecraft:oak_sign{BlockEntityTag:{Text1:'[{"text":"","clickEvent":{"action":"run_command","value":"function poka:choose_assassin"}},{"text":"\\u30a2\\u30b5\\u30b7\\u30f3","bold":true,"underlined":true},{"text":"\\u3092\\u9078\\u629e"}]'},display:{Name:'{"text":"Custom Sign"}'}}
#看板の設置コマンド
...
execute as @s[scores={chose = 0}] run scoreboard players set @s[scores={chose = 0}] Assassin 1
...
tag @s add ready
execute as @s[scores={Assassin = 1}] run tp @s -4.5 -22 28.5
