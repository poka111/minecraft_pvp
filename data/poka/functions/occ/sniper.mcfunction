...
#神速4
give @a[scores={sniper = 1}] minecraft:firework_rocket{CanPlaceOn:["#minecraft:all"],HideFlags: 16,CustomModelData:3,display:{Name:"{\"text\":\"神速\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"3秒間、速度を大幅に上昇させる。\",\"italic\":false,\"color\":\"white\"}"]}} 4
#克服20
give @a[scores={sniper = 1}] minecraft:firework_rocket{CanPlaceOn:["#minecraft:all"],HideFlags: 16,CustomModelData:4,display:{Name:"{\"text\":\"克服\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"付与されているデバフを解除する。\",\"italic\":false,\"color\":\"white\"}"]}} 20
#跳躍20
give @a[scores={sniper = 1}] minecraft:firework_rocket{CanPlaceOn:["#minecraft:all"],HideFlags: 16,CustomModelData:7,display:{Name:"{\"text\":\"跳躍\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"3秒間、跳躍力が上昇する。\",\"italic\":false,\"color\":\"white\"}"]}} 20
#レーダービジョン5
give @a[scores={sniper = 1}] minecraft:firework_rocket{CanPlaceOn:["#minecraft:all"],HideFlags: 16,CustomModelData:1,display:{Name:"{\"text\":\"レーダービジョン\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"敵全員に10秒間発光を付与する。\",\"italic\":false,\"color\":\"white\"}"]}} 5
#奥義：四線夜纏一弓
give @a[scores={sniper = 1,ULT_sisen = 0}] minecraft:firework_rocket{CanPlaceOn:["#minecraft:all"],HideFlags: 16,CustomModelData:21,display:{Name:"{\"text\":\"四線夜纏一弓【奥義】\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"15秒間、解除不可能のデバフを付与し、相手を宙に浮かせる。\",\"italic\":false,\"color\":\"white\"}","{\"text\":\"更に、使用後は体力が上昇する。\",\"italic\":false,\"color\":\"white\"}"]}} 1

#体力を設定(6)
attribute @a[scores={sniper = 1},limit=1] minecraft:generic.max_health base set 6
effect give @a[scores={sniper = 1}] minecraft:instant_health 1 10