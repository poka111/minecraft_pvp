...
execute as @a[scores={snipe = 80..,sniper = 1}] run scoreboard players set @a[scores={snipe = 80..,sniper = 1}] canSnipe 1
execute as @a[scores={snipe = 80..,sniper = 1}] run scoreboard players set @a[scores={snipe = 80..,sniper = 1}] snipe 0
