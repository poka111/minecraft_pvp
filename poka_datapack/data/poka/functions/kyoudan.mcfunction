...
#超再生1
give @a[scores={Kyoudan = 1}] minecraft:firework_rocket{CustomModelData:6,display:{Name:"{\"text\":\"超再生\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"30秒間、かなり体力が回復する。\",\"italic\":false,\"color\":\"white\"}"]}} 1

#跳躍10
give @a[scores={Kyoudan = 1}] minecraft:firework_rocket{CustomModelData:7,display:{Name:"{\"text\":\"跳躍\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"3秒間、跳躍力が上昇する。\",\"italic\":false,\"color\":\"white\"}"]}} 10

#克服10
give @a[scores={Kyoudan = 1}] minecraft:firework_rocket{CustomModelData:4,display:{Name:"{\"text\":\"克服\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"付与されているデバフを解除する。\",\"italic\":false,\"color\":\"white\"}"]}} 10

#神速2
give @a[scores={Kyoudan = 1}] minecraft:firework_rocket{CustomModelData:3,display:{Name:"{\"text\":\"神速\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"3秒間、速度を大幅に上昇させる。\",\"italic\":false,\"color\":\"white\"}"]}} 2

#レーダービジョン5
give @a[scores={Kyoudan = 1}] minecraft:firework_rocket{CustomModelData:1,display:{Name:"{\"text\":\"レーダービジョン\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"敵全員に10秒間発光を付与する。\",\"italic\":false,\"color\":\"white\"}"]}} 5

#ヒールⅢ 1
give @a[scores={Kyoudan = 1}] minecraft:firework_rocket{CustomModelData:13,display:{Name:"{\"text\":\"ヒールⅢ\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"体力がかなり回復する。\",\"italic\":false,\"color\":\"white\"}"]}} 1
