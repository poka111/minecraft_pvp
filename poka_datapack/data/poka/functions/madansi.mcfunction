...
#再生 1
give @a[scores={Madansi = 1}] minecraft:firework_rocket{CustomModelData:5,display:{Name:"{\"text\":\"再生\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"30秒間、少し体力が回復する。\",\"italic\":false,\"color\":\"white\"}"]}} 1
...
#レーダービジョン 5
give @a[scores={Madansi = 1}] minecraft:firework_rocket{CustomModelData:1,display:{Name:"{\"text\":\"レーダービジョン\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"敵全員に10秒間発光を付与する。\",\"italic\":false,\"color\":\"white\"}"]}} 5

#神速 5
give @a[scores={Madansi = 1}] minecraft:firework_rocket{CustomModelData:3,display:{Name:"{\"text\":\"神速\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"3秒間、速度を大幅に上昇させる。\",\"italic\":false,\"color\":\"white\"}"]}} 1

#天命の創造 1
give @a[scores={Madansi = 1}] minecraft:firework_rocket{CustomModelData:16,display:{Name:"{\"text\":\"天命の創造\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"体力をかなり上昇させる。\",\"italic\":false,\"color\":\"white\"}"]}} 1

#ヒールⅠ 2
give @a[scores={Madansi = 1}] minecraft:firework_rocket{CustomModelData:11,display:{Name:"{\"text\":\"ヒールⅠ\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"体力が少し回復する。\",\"italic\":false,\"color\":\"white\"}"]}} 2

#奥義：無限魔装弾
give @a[scores={Madansi = 1,ULT_Madansi = 0}] minecraft:firework_rocket{CustomModelData:21,display:{Name:"{\"text\":\"無限魔装弾【奥義】\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"30秒間、魔力が無制限になる。\",\"italic\":false,\"color\":\"white\"}"]}} 1