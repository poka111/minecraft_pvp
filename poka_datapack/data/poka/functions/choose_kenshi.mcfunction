...
#看板のgiveコマンド
#/give @p minecraft:oak_sign{BlockEntityTag:{Text1:'[{"text":"","clickEvent":{"action":"run_command","value":"function poka:choose_kenshi"}},{"text":"\\u5263\\u58eb","bold":true,"underlined":true,"color":"#515155"},{"text":"\\u3092\\u9078\\u629e"}]'},display:{Name:'{"text":"Custom Sign"}'}}
#設置コマンド
...
execute as @p[scores={chose = 0}] run scoreboard players set @p[scores={chose = 0}] Kenshi 1
...
execute as @p[scores={Kenshi = 1}] run tp @p 11 -22 28
