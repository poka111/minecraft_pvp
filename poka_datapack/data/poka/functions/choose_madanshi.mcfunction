...
#看板のgiveコマンド
#/give @p minecraft:oak_sign{BlockEntityTag:{Text1:'[{"text":"","clickEvent":{"action":"run_command","value":"function poka:choose_madanshi"}},{"text":"\\u9b54\\u5f3e\\u58eb","bold":true,"underlined":true,"color":"dark_purple"},{"text":"\\u3092\\u9078\\u629e"}]'},display:{Name:'{"text":"Custom Sign"}'}}
#設置コマンド
...
execute as @p[scores={chose = 0}] run scoreboard players set @p[scores={chose = 0}] Madansi 1
...
execute as @p[scores={Madansi = 1}] run tp @p 11 -22 28
