...
#看板のgiveコマンド
#/give @p minecraft:oak_sign{BlockEntityTag:{Text1:'{"text":"\\u30e9\\u30f3\\u30d0\\u30fc\\u30b8\\u30e3\\u30c3\\u30af","clickEvent":{"action":"run_command","value":"function poka:choose_lumber"},"bold":true,"underlined":true,"color":"#1F6E2E"}',Text2:'{"text":"\\u3092\\u9078\\u629e"}'},display:{Name:'{"text":"Custom Sign"}'}}
#設置コマンド
...
execute as @p[scores={chose = 0}] run scoreboard players set @p[scores={chose = 0}] Lumber 1
...
execute as @p[scores={Lumber = 1}] run tp @p 11 -22 28
