...
#看板のgiveコマンド
#/give @p minecraft:oak_sign{BlockEntityTag:{Text1:'[{"text":"","clickEvent":{"action":"run_command","value":"function poka:choose_bommer"}},{"text":"\\u30dc\\u30de\\u30fc","bold":true,"underlined":true,"color":"dark_green"},{"text":"\\u3092\\u9078\\u629e"}]'},display:{Name:'{"text":"Custom Sign"}'}}
#設置コマンド
...
execute as @p[scores={chose = 0}] run scoreboard players set @p[scores={chose = 0}] Bommer 1
...
execute as @p[scores={Bommer = 1}] run tp @p 11 -22 28
