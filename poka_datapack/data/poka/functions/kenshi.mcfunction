...
#レーダービジョン8
give @a[scores={Kenshi = 1}] minecraft:firework_rocket{CustomModelData:1,display:{Name:"{\"text\":\"レーダービジョン\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"敵全員に10秒間発光を付与する。\",\"italic\":false,\"color\":\"white\"}"]}} 8
#克服10
give @a[scores={Kenshi = 1}] minecraft:firework_rocket{CustomModelData:4,display:{Name:"{\"text\":\"克服\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"付与されているデバフを解除する。\",\"italic\":false,\"color\":\"white\"}"]}} 10
#再生5
give @a[scores={Kenshi = 1}] minecraft:firework_rocket{CustomModelData:5,display:{Name:"{\"text\":\"再生\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"30秒間、少し体力が回復する。\",\"italic\":false,\"color\":\"white\"}"]}} 5
#ファランクス9
give @a[scores={Kenshi = 1}] minecraft:firework_rocket{CustomModelData:2,display:{Name:"{\"text\":\"ファランクス\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"7秒間、被ダメージを80%カットする。\",\"italic\":false,\"color\":\"white\"}"]}} 9
#ヒールⅠ 10
give @a[scores={Kenshi = 1}] minecraft:firework_rocket{CustomModelData:11,display:{Name:"{\"text\":\"ヒールⅠ\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"体力が少し回復する。\",\"italic\":false,\"color\":\"white\"}"]}} 10
#奥義　鋼強創体
give @a[scores={Kenshi = 1,ULT_Kensi = 0}] minecraft:firework_rocket{CustomModelData:21,display:{Name:"{\"text\":\"鋼強創体【奥義】\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"25秒間、被ダメージを100%カットする。\",\"italic\":false,\"color\":\"white\"}"]}} 1
