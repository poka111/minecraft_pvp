...
#ボムフレア10
give @a[scores={Bommer = 1}] minecraft:parrot_spawn_egg{EntityTag:{id:"minecraft:slime",DeathTime:19,DeathLootTable:"0",Silent:1b,Invulnerable:1b,NoAI:1b,Size:0,CustomName:"\"ボムフレア\"",CustomNameVisible:0},display:{Name:"{\"text\":\"ボムフレア\",\"color\":\"gold\"}",Lore:['[{"text":"自分が爆発する"}]']}} 10
#ボムブレイク64
give @a[scores={Bommer = 1}] minecraft:firework_rocket{CustomModelData:9,display:{Name:"{\"text\":\"ボムブレイク【無限スキル】\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"全てのクリーパーを爆発させる。\",\"italic\":false,\"color\":\"white\"}"]}} 64
#ヒールⅡ 6
give @a[scores={Bommer = 1}] minecraft:firework_rocket{CustomModelData:12,display:{Name:"{\"text\":\"ヒールⅡ\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"体力が回復する。\",\"italic\":false,\"color\":\"white\"}"]}} 6
#克服20
give @a[scores={Bommer = 1}] minecraft:firework_rocket{CustomModelData:4,display:{Name:"{\"text\":\"克服\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"付与されているデバフを解除する。\",\"italic\":false,\"color\":\"white\"}"]}} 20
#爆発矢64
