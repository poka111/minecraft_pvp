...
#魔法切り替え64
give @a[scores={magician = 1}] minecraft:drowned_spawn_egg{CustomModelData:1,EntityTag:{id:"minecraft:slime",DeathTime:19,DeathLootTable:"0",Silent:1b,Invulnerable:1b,NoAI:1b,Size:0,CustomName:"\"魔法切り替え\"",CustomNameVisible:0},display:{Name:"{\"text\":\"魔法切り替え\",\"color\":\"gold\"}",Lore:['[{"text":"発動する魔法を切り替える"}]']}} 64
#天命の風5
give @a[scores={magician = 1}] minecraft:firework_rocket{CustomModelData:14,display:{Name:"{\"text\":\"天命の風\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"体力を少し上昇させる。\",\"italic\":false,\"color\":\"white\"}"]}} 5
#克服10
give @a[scores={magician = 1}] minecraft:firework_rocket{CustomModelData:4,display:{Name:"{\"text\":\"克服\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"付与されているデバフを解除する。\",\"italic\":false,\"color\":\"white\"}"]}} 10
#レーダービジョン10
give @a[scores={magician = 1}] minecraft:firework_rocket{CustomModelData:1,display:{Name:"{\"text\":\"レーダービジョン\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"敵全員に10秒間発光を付与する。\",\"italic\":false,\"color\":\"white\"}"]}} 10
#神速3
give @a[scores={magician = 1}] minecraft:firework_rocket{CustomModelData:3,display:{Name:"{\"text\":\"神速\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"3秒間、速度を大幅に上昇させる。\",\"italic\":false,\"color\":\"white\"}"]}} 3
#MPを付与(初期値：100,上限値：100)
give @a[scores={magician = 1}] minecraft:nether_star{display:{Name:"\"魔力\""}} 100
#魔法瓶(MP:50回復)×2
...
give @a[scores={magician = 1,ULT_burst = 0}] minecraft:firework_rocket{CustomModelData:21,display:{Name:"{\"text\":\"バーストエクスプロージョン【奥義】\",\"italic\":false,\"color\":\"gold\"}",Lore:["{\"text\":\"前方広範囲に強力な爆発を起こす\",\"italic\":false,\"color\":\"white\"}"]}} 1
