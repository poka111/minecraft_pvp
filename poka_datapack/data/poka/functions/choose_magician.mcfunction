...
#看板のgiveコマンド
#/give @p minecraft:oak_sign{BlockEntityTag:{Text1:'[{"text":"","clickEvent":{"action":"run_command","value":"function poka:choose_magician"}},{"text":"\\u9b54\\u6cd5\\u5e2b","bold":true,"underlined":true,"color":"#E708EA"},{"text":"\\u3092\\u9078\\u629e"}]'},display:{Name:'{"text":"Custom Sign"}'}}
#設置コマンド
...
execute as @p[scores={chose = 0}] run scoreboard players set @p[scores={chose = 0}] magician 1
...
execute as @p[scores={magician = 1}] run tp @p 11 -22 28
