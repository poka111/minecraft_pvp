...
#看板のgiveコマンド
#/give @p minecraft:oak_sign{BlockEntityTag:{Text1:'[{"text":"","clickEvent":{"action":"run_command","value":"function poka:choose_sniper"}},{"text":"\\u30b9\\u30ca\\u30a4\\u30d1\\u30fc","bold":true,"underlined":true,"color":"dark_aqua"},{"text":"\\u3092\\u9078\\u629e"}]'},display:{Name:'{"text":"Custom Sign"}'}}
#設置コマンド
...
execute as @p[scores={chose = 0}] run scoreboard players set @p[scores={chose = 0}] sniper 1
...
execute as @p[scores={sniper = 1}] run tp @p 11 -22 28
